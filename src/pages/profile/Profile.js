...
const Profile = () => {
  ...
  return (
    ...
    <div className='box'>
    <div className='flex '>
         <div className="flex"  style={{flexDirection:'column'}}><img onClick={othersprofile} style={{cursor:'pointer'}} className='profileimg' src={`http://localhost:3002/assets/${particularpost.userPicturePath}`} alt="" />
